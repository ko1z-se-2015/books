    ...
    <div class="products">
        <div class="filter">
            ...
            <div class="functionality">
                <div><a class="text1" href="../pages/education.php">По популярности </a></div>
                <div><a class="text2" href="../pages/education_by_p_low.php">По убыванию цены </a></div>
                <div><a class="text3" href="../pages/education_by_p_high.php">По возрастанию цены</a></div>
                <div><a class="text4" href="../pages/education_by_name.php">По названию</a></div>
            </div>
        </div>
        <div class="clone_filter">
            <div class="big_text">Фильтры</div>
            <div class="line"><a class="text1" href="../pages/education.php">По популярности </a></div>
            <div class="line"><a class="text2" href="../pages/education_by_p_low.php">По убыванию цены </a></div>
            <div class="line"><a class="text3" href="../pages/education_by_p_high.php">По возрастанию цены</a></div>
            <div class="line"><a class="text4" href="../pages/education_by_name.php">По названию</a></div>
        </div>
        <div class="books">

            <div class="row_books">
                <?php
                $book = mysqli_query($mysql, "SELECT * FROM `books` WHERE `categery_id` = 5  ORDER BY `price` DESC LIMIT 0,4 ");
            ...
            <div class="row_books">
                <?php
                $book = mysqli_query($mysql, "SELECT * FROM `books` WHERE `categery_id` = 5 ORDER BY `price` DESC LIMIT 4,4");
                while ($b = mysqli_fetch_assoc($book)) {
                    ?>
                    <div class="book">
                        <form action="../funcionality/fun_sc.php" method="post">
            ...
            <div class="row_books">
                <?php
                $book = mysqli_query($mysql, "SELECT * FROM `books` WHERE `categery_id` = 5 ORDER BY `price`DESC LIMIT 8,4");
                while ($b = mysqli_fetch_assoc($book)) {
                    ?>
                    <div class="book">
                        <form action="../funcionality/fun_sc.php" method="post">
