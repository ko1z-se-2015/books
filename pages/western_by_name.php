...
<head>
    ...
    <title>Вестерн литература</title>
    <script>
    ...
    <div class="products">
        <div class="filter">
            ...
            <div class="functionality">
                <div><a class="text1" href="../pages/western.php">По популярности </a></div>
                <div><a class="text2" href="../pages/western_by_p_low.php">По убыванию цены </a></div>
                <div><a class="text3" href="../pages/western_by_p_high.php">По возрастанию цены</a></div>
                <div><a class="text4" href="../pages/western_by_name.php">По названию</a></div>
            </div>
        </div>
        <div class="clone_filter">
            <div class="big_text">Фильтры</div>
            <div class="line"><a class="text1" href="../pages/western.php">По популярности </a></div>
            <div class="line"><a class="text2" href="../pages/western_by_p_low.php">По убыванию цены </a></div>
            <div class="line"><a class="text3" href="../pages/western_by_p_high.php">По возрастанию цены</a></div>
            <div class="line"><a class="text4" href="../pages/western_by_name.php">По названию</a></div>
        </div>
        <div class="books">

            <div class="row_books">
                <?php
                $book = mysqli_query($mysql, "SELECT * FROM `books` WHERE `categery_id` = 3 ORDER by `name` ASC LIMIT 0,4");
            ...
            <div class="row_books">
                <?php
                $book = mysqli_query($mysql, "SELECT * FROM `books` WHERE `categery_id` = 3 ORDER by `name` ASC LIMIT 4,4");
                while ($b = mysqli_fetch_assoc($book)) {
                    ?>
                    <div class="book">
                        <form action="../funcionality/fun_sc.php" method="post">
            ...
            <div class="row_books">
                <?php
                $book = mysqli_query($mysql, "SELECT * FROM `books` WHERE `categery_id` = 3 ORDER by `name` ASC LIMIT 8,4");
                while ($b = mysqli_fetch_assoc($book)) {
                    ?>
                    <div class="book">
                        <form action="../funcionality/fun_sc.php" method="post">
